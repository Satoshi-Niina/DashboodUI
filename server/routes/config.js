...
router.get('/', (req, res) => {
    ...
    const config = {
        endpoints: {
            planning: process.env.URL_PLANNING || 'https://operation-management-client-800711608362.asia-northeast2.run.app',
        ...
        planningApiUrl: process.env.URL_PLANNING_API || 'https://operation-management-server-800711608362.asia-northeast2.run.app',
